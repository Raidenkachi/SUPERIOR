...
class AsakeamapianoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_asakeamapiano)


        val mediaPlayer = MediaPlayer.create(this,R.raw.asakeamapiano)
