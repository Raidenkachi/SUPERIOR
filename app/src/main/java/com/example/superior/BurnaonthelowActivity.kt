...
class BurnaonthelowActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_burnaonthelow)

        val mediaPlayer = MediaPlayer.create(this,R.raw.burnaonthelow)
