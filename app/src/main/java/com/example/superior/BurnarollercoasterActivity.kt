...
class BurnarollercoasterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_burnarollercoaster)

        val mediaPlayer = MediaPlayer.create(this,R.raw.burnarollercoaster)
