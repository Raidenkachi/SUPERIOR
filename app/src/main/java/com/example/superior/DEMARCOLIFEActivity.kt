...
class DEMARCOLIFEActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_demarcolifeactivity)

        val mediaPlayer = MediaPlayer.create(this,R.raw.demarcolove)
