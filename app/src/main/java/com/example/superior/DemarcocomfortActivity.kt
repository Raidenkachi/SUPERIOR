...
class DemarcocomfortActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_demarcocomfort)


        val mediaPlayer = MediaPlayer.create(this,R.raw.demarcocomfort)
