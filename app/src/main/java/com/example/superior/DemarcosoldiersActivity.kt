...
class DemarcosoldiersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_demarcosoldiers)

        val mediaPlayer = MediaPlayer.create(this,R.raw.demarcosoldiers)
