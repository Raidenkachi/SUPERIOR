...
class DiggaBluwuuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_digga_bluwuu)


        val mediaPlayer = MediaPlayer.create(this,R.raw.diggabluwuu)
        ...
        back.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, DiggaspidermanActivity::class.java)
                startActivity(intent)
                finish()
            }
        }
