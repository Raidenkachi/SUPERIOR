...
class EminemMockingbirdActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eminem_mockingbird)

        val mediaPlayer = MediaPlayer.create(this,R.raw.eminemmockingbird)
