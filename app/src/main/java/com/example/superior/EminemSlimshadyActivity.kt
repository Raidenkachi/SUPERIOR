...
class EminemSlimshadyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eminem_slimshady)

        val mediaPlayer = MediaPlayer.create(this,R.raw.eminemslimshady)
