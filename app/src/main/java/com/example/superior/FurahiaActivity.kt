...
class FurahiaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_furahia)

        val mediaPlayer = MediaPlayer.create(this,R.raw.mejafurahia)
        ...
        back.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, SiskiiActivity::class.java)
                startActivity(intent)
                finish()
            }
        }
