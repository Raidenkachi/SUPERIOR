...
class KonshensbrukoffActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_konshensbrukoff)


        val mediaPlayer = MediaPlayer.create(this,R.raw.konshensbrukoff)
