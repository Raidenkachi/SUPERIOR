...
class KonshensbubbleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_konshensbubble)

        val mediaPlayer = MediaPlayer.create(this,R.raw.konshensbubble)
