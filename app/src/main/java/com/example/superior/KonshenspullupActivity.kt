...
class KonshenspullupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_konshenspullup)

        val mediaPlayer = MediaPlayer.create(this,R.raw.konshenspullup)
