...
class KonshensturnmeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_konshensturnme)

        val mediaPlayer = MediaPlayer.create(this,R.raw.konshensturnmeon)
