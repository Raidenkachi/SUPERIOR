...
class McmcaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mcmca)

        val mediaPlayer = MediaPlayer.create(this,R.raw.wakadinali_mcmca_official_music_video_mp3_44076)
