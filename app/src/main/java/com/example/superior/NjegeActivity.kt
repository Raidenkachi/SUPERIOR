...
class NjegeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_njege)

        val mediaPlayer = MediaPlayer.create(this,R.raw.njege_ma_sanse_fan_made_visual_wakadinali_victims_of_madness_mp3_44435)
