...
class NyovestimbanjeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nyovestimbanje)

        val mediaPlayer = MediaPlayer.create(this,R.raw.nyovestimbanje)
        ...
        next.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, NyovestkabzaActivity::class.java)
        ...
        back.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, NyovestbustaActivity::class.java)
                startActivity(intent)
                finish()
            }
        }
