...
class NyovestkabzaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nyovestkabza)

        val mediaPlayer = MediaPlayer.create(this,R.raw.nyovestkabza)
        ...
        next.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, NyoveststudioActivity::class.java)
        ...
        back.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, NyovestimbanjeActivity::class.java)
                startActivity(intent)
                finish()
            }
        }
