...
class NyoveststudioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nyoveststudio)

        val mediaPlayer = MediaPlayer.create(this,R.raw.nyoveststudio)
        ...
        next.setOnClickListener {
            if (!mediaPlayer.isPlaying){
                mediaPlayer.stop()
                val intent = Intent(this, NyovestwozaActivity::class.java)
