...
class PopcaancelebrateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_popcaancelebrate)

        val mediaPlayer = MediaPlayer.create(this,R.raw.popcaancelebrate)
