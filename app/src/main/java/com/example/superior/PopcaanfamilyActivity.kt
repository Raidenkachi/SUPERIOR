...
class PopcaanfamilyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_popcaanfamily)

        val mediaPlayer = MediaPlayer.create(this,R.raw.popcaanfamily)
