...
class RemasoundgasmActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_remasoundgasm)

        val mediaPlayer = MediaPlayer.create(this,R.raw.remasoundgasm)
