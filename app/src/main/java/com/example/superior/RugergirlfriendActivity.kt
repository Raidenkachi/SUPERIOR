...
class RugergirlfriendActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rugergirlfriend)

        val mediaPlayer = MediaPlayer.create(this,R.raw.rugergirlfriend)
