...
class SikutambuiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sikutambui)

        val mediaPlayer = MediaPlayer.create(this,R.raw.wakadinalisikutambui)
