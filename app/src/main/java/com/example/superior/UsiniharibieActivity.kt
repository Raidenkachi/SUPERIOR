...
class UsiniharibieActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_usiniharibie)

        val mediaPlayer = MediaPlayer.create(this,R.raw.mejausiniharibiemood)
